...
from back.utils.util import Colors, remove_out_of_BBox, draw_detect_result, TF_detect_area, \
    ...
    for camera_name, camera_info in camera_info_dict_ori.items():
        ...
        if len(camera_info["detect_info"]):        
            ...
            if cap.isOpened():
                ...
                print(f"disconnect Camera {camera_name}")

    conf_score = 0.05
    fire_conf_score = 0.5

    model_name = "ms-ai2405-finetune_M"
