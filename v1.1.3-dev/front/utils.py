            ...
            while self.__thread_active:
                ...
                if cap.frame_available() and not self.__thread_pause:
                    ...
                    if self.plot_detect and receive_data[self.camera_name]:
                        ...
                        frame_save = plot_detect_info(img = frame_save, detect_info = receive_data[self.camera_name], roi_thickness = self.roi_thickness, plot_bbox = self.plot_bbox, plot_label = self.plot_label)
