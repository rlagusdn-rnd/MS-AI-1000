...
MS_AI_PATH="/home/$USER/workspace/MS-AI_1000_v1.1_dev"
...
docker start ms-ai
docker exec -it ms-ai sh -c \"python3 /root/workspace/MS-AI_1000_v1.1_dev/main.py\"" > ms-ai.sh

# 생성한 sh 파일을 실행하는 .desktop 파일을 생성합니다.
echo "[Desktop Entry]
Encoding=UTF-8
Name=MS-AI_1000_v1.1
Type=Application
