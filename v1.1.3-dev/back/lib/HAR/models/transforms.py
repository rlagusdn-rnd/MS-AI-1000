...
def to_normalized_float_one_tensor(vid):
    return (vid.permute(2, 0, 1).to(torch.float32) / 255).unsqueeze(0)
...
class ToFloatTensorInZeroOne_Only_one(object):
    def __call__(self, vid):
        return to_normalized_float_one_tensor(vid)
