...
def ms_labeler(camera_list_path:str, weight_name:str, zero_shot_flag):
    ...
    yolo_weight_path = os.path.join(os.getcwd(), "back", "weights", "yolo", weight_name)
                ...
                with torch.no_grad():
                    ...
                    for video_name in video_name_list:
                        try:
                            ...
                            if zero_shot_flag:
                                processor = AutoProcessor.from_pretrained(os.path.join(os.getcwd(), "back", "weights", "grounding-dino-base"))
                                zero_shot_ob_model = AutoModelForZeroShotObjectDetection.from_pretrained(os.path.join(os.getcwd(),"back", "weights", "grounding-dino-base")).to(device)
...
def train(NVR_IP:str, weight_name:str):
    ...
    yolo_weight_path = os.path.join(os.getcwd(), "back", "weights", "yolo")
