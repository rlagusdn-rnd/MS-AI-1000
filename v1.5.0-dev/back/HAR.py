...
# 로깅 설정
logger = setup_logging(logger_name="HAR_server")
        ...
        messages = [{
                        ...
                        "content": [
                            ...
                            {"type": "text", "text": "Please watch the video and write a report explaining the video according to the form that follows.\n"+
                                                    "1. **Full video description**: [Video description]\n"+
                                                    "2. **Explanation of behavior towards people**: [Movement towards people]\n"+
                                                    "3. **Situation Summary**: [Situation Summary]\n"+
                                                    f"4. **Final Answer**: [Is a {detect_type} detected based on video analysis? If yes, yes; if no, no]\n\n"
                                                }
                        ],
                    }]

        response = requests.post(vlm_url, json={"question": messages, "video_path": video_path}) 
