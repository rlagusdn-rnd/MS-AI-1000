...
def save_final_dataset(event_name, img_buffer, label_buffer, data_save_dir):
...
def check_LLM(model_path, img_buffer, label, verbose = False):
...
def create_dataset_list(dataset_path, NVR_IP):
    train_txt = ""
    val_txt = ""
...
def move_dataset_list(dataset_path, NVR_IP):
