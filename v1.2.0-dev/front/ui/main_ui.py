...
"")
        icon2 = QIcon()
        icon2.addFile(u":/newPrefix/images/ico_ai_setting.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/images/ico_timer.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/images/search_ico.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/images/ico_add_circle.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.setting_ai_bnt.setFont(font12)
        self.setting_ai_bnt.setCursor(QCursor(Qt.PointingHandCursor))
        self.setting_ai_bnt.setStyleSheet(u"border-radius: 20px;\n"
"border: 1px solid rgb(179,179,179);\n"
"color: rgb(255, 255, 255);\n"
"background-color: rgba(0, 0, 0, 0);\n"
"")
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/images/icon-switch-off.png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Normal, QIcon.On)
        icon6.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Disabled, QIcon.On)
...
"")
        ...
        self.setting_ai_weight_label.setMaximumSize(QSize(176, 28))
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.setting_setting_ai_weight_box.setFont(font6)
...
"")
        ...
        self.setting_self_training_label_2 = QLabel(self.setting_ai_tab)
        self.setting_self_training_label_2.setObjectName(u"setting_self_training_label_2")
        self.setting_self_training_label_2.setMinimumSize(QSize(110, 28))
        self.setting_self_training_label_2.setMaximumSize(QSize(110, 28))
        self.setting_self_training_label_2.setFont(font12)
        self.setting_self_training_label_2.setStyleSheet(u"color: rgb(179,179,179);\n"
"background-color: rgba(255, 255, 255, 0);")
        self.setting_self_training_label_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_55.addWidget(self.setting_self_training_label_2)

        self.setting_detect_label_active_bnt_2 = QPushButton(self.setting_ai_tab)
        self.setting_detect_label_active_bnt_2.setObjectName(u"setting_detect_label_active_bnt_2")
        self.setting_detect_label_active_bnt_2.setMinimumSize(QSize(61, 25))
        self.setting_detect_label_active_bnt_2.setMaximumSize(QSize(61, 25))
        self.setting_detect_label_active_bnt_2.setIcon(icon6)
        self.setting_detect_label_active_bnt_2.setIconSize(QSize(55, 103))
        self.setting_detect_label_active_bnt_2.setCheckable(True)

        self.horizontalLayout_55.addWidget(self.setting_detect_label_active_bnt_2)
        ...
        self.setting_self_training_label.setMaximumSize(QSize(132, 28))
        self.setting_self_training_label.setFont(font12)
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.setting_self_training_start_box.setFont(font6)
...
"")
        ...
        self.time_tilde.setFont(font16)
...
"background-color: rgba(191, 64, 64, 0);")
        ...
        self.setting_self_training_end_box.setFont(font6)
...
"")
        ...
        self.horizontalSpacer_53 = QSpacerItem(269, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.setting_ai_setting_svae_bnt.setCursor(QCursor(Qt.PointingHandCursor))
...
"")
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/images/ico_arrow_right.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"Rotation: ( origin.x: 25; origin.y: 25; angle: 45);")
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/images/ico_arrow_left.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        icon9 = QIcon()
        icon9.addFile(u":/newPrefix/images/icon-switch-off.png", QSize(), QIcon.Normal, QIcon.Off)
        icon9.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Normal, QIcon.On)
        icon9.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Disabled, QIcon.On)
        icon9.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Active, QIcon.On)
        icon9.addFile(u":/newPrefix/images/icon-switch-on.png", QSize(), QIcon.Selected, QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.verson_label.setText(QCoreApplication.translate("MainWindow", u"MS-AI1000 1.2.0", None))
        ...
        self.setting_self_training_label_2.setText(QCoreApplication.translate("MainWindow", u"\uc790\uac00\ud559\uc2b5 \ud65c\uc131\ud654", None))
        self.setting_detect_label_active_bnt_2.setText("")
