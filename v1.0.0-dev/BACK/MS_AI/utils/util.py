...
class AI_Msg_Buffer(object):
    ...
    def push_camera_data(self, data):
        self.data = data

    def get_data(self):
        return self.data

    def set_snapshot_flag(self, data):
        self.snapshot_flag = data

    def set_record_flag(self, data):
        self.video_record_flag = data
    ...
    def get_record_flag(self):
        return self.video_record_flag

    def reset_data(self, camera_id):
        self.data[camera_id] = []

    def set_check_connect_flag(self, data):
        self.connect_flag = data

    def get_check_connect_flag(self):
...
class Video_Buffer():
    ...
    def get_frame(self):
        ...
        # self._frame = cv2.resize(self._frame, (1920,1080))
...
def build_cfg_path(yml_path, feature_type: str) -> os.PathLike:
    ...
    '''
    path = yml_path + f'/{feature_type}.yml'
    return path
