...
from MS_AI.models.transforms import (CenterCrop, Normalize, Resize,
                               ToFloatTensorInZeroOne, ToFloatTensorInZeroOne_Only_one)
                        
from MS_AI.models._base.base_framewise_extractor import BaseFrameWiseExtractor
import omegaconf
from MS_AI.models.clip import clip_src as clip
import cv2
import math
import os
...
class Action_Classification_Model_Vit_b1(torch.nn.Module):
    def __init__(self):
        super().__init__()
